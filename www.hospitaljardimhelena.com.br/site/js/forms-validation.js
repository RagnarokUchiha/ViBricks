...
function validateAppoint() {
    ...
    if (flag == 0)
    {
        $.ajax({
            type: "POST",
            url: actualUrl + "contato/contatohome/",
            dataType:"json",
            ...
            success: function (msg)
            {
                ...
                if (msg.success) {
                    ...
                    document.getElementById("message-app").innerHTML = "Obrigado por entrar em contato conosco";
...
function validateNewsletter() {
    ...
    if (flag == 0)
    {
        $.ajax({
            type: "POST",
            url: actualUrl + "index/newsletter/",
...
function validateContact() {
    ...
    if (assunto.value == "")
    {   
        $("#uniform-assunto").css({"border-color": "#FE847B", 
             "border-width":"1px", 
             "border-style":"solid"});
        flag = 1;
    } 
    ...
    if (flag == 0)
    {
        $.ajax({
            type: "POST",
            url: actualUrl + "contato/contatodentro",
            ...
            success: function (retornojson)
            {
                ...
                $('#msg').val('');
                //alert(msg);
                if (retornojson.success) {
                    $('#message-contact').fadeIn(2000);
                    alert('Contato enviado com sucesso');
                    document.getElementById("message-contact").innerHTML = retornojson.msg;
